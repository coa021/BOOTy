...
static void MX_GPIO_Init(void) {
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TIMER_TEST_BTN_GPIO_Port, TIMER_TEST_BTN_Pin,
                    GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : TIMER_TEST_BTN_Pin */
  GPIO_InitStruct.Pin = TIMER_TEST_BTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TIMER_TEST_BTN_GPIO_Port, &GPIO_InitStruct);
